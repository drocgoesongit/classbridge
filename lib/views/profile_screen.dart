    ...
    return Scaffold(
      appBar: AppBar(
        title: const Row(children: [
            ...
            SizedBox(width: 10),
            Text('Profile', style: TextStyle(fontFamily: 'Gilroy', fontWeight: FontWeight.w600, fontSize: 20),),
          ],)
      ),
          ...
          child: Consumer<FetchData>(
            builder: (context, data, child) {
              ...
              ListTile(
                ...
                title: Text('Joined on ${HelperClass.formatTimestampToAmPm(data.user!.loginTimestamp)}'),
              ),
              ListTile(
                onTap: () {
